    ...
    <nav class="bg-white border-b border-stone-200 sticky top-0 z-20 shadow-sm">
      <div class="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-16 items-center gap-8">
        ...
        <div class="flex items-center gap-6 shrink-0">
          <RouterLink to="/discover" class="text-sm font-medium text-stone-500 hover:text-stone-900 hidden lg:block transition">Discover</RouterLink>
          ...
          <RouterLink to="/invitations" class="relative cursor-pointer hover:text-amber-700 transition text-stone-400">
